...
def backtesting(env_test, model):
    ...
    baseline_stats.to_csv("./"+RESULTS_DIR+"/baseline_stats_"+now+'.csv')
...
if __name__ == "__main__":
    ...
    if args.model_path is None:
        ...
        # save model
        trained_model.save(f'trained_models/{args.model_name}')
    else:
        ...
        model_class = {"ppo": PPO, "sac": SAC, "a2c": A2C, 'ddpg': DDPG, 'td3': TD3}[args.algo]
